...
<body>
        	...
        	<div id="header_friends_box">
        		...
        		<?php if(isset($friends_data["data"]) && !empty($friends_data["data"])): ?>
        			<?php foreach($friends_data["data"] as $friendData): ?>
        				...
        				?>
        				<a href="<?php echo $this->Html->url('/facebook/friendPage/' . $id . '/' . $name, true); ?>">
	...
	<div id="modal">
		...
		<!--</div>-->
	    <!--<div class="top_logo">-->
	    	<?php echo $this->Html->image("top_logo.png", array("class" => "top_logo")); ?>
	    <!--</div>-->
	    <div class="top_searchbox">
	    	<?php echo $this->Form->input("dammy", array("id" => "search", "placeholder" => "友人を検索...", "class" => "searchbox", "label" => false)); ?>
	    	<div id="suggest"></div>
	    </div>
	</div>
	<?php echo $this->Html->image("modal_close.png", array("class" => "modal_close")); ?>
	...
	*/
	...
	<script>
		...
		new Suggest.Local("search", "suggest", nameList);
